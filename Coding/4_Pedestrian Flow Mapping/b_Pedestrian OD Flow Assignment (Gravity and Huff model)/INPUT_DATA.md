...
| Building footprints with archetypes | `building/sg_buildings_v5.geojson` | 118,782 polygons, EPSG:3414, `gross_floor_area`, `building_archetype` (21 classes: hdb, office, retail, mixed_development, industrial, hotel, hospital, ...) | URA / OSM footprints with GFA and an archetype classification (authors' base data) | destinations |
...
| Island boundary | `Island_boarder/Island_boarder.shp` | 14 polygons | authors' base data | network and stations clipped to it |
...
the derived products (`pedestrian_network_filtered.gpkg`, `station_hourly_ridership.gpkg`,
`building_hourly_weight.gpkg`, `flow_weekday_HH.gpkg`) are distributed with the data repository of the paper.
