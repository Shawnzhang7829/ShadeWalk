...
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/routing_flow/step4_4c_city_routing.py` | `D:\Claude\SVI_FFW\output\step5_nav_webapp\step4_4c_city_routing.py` |  |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/routing_flow/step4_4c_orig_flow.py` | `D:\Claude\SVI_FFW\output\step5_nav_webapp\step4_4c_orig_flow.py` |  |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/routing_flow/step4_4c_orig_coolflow.py` | `D:\Claude\SVI_FFW\output\step5_nav_webapp\step4_4c_orig_coolflow.py` |  |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/routing_flow/step4_4e_flow_detour.py` | `D:\Claude\SVI_FFW\output\step5_nav_webapp\step4_4e_flow_detour.py` |  |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/routing_flow/step4_4f_flow_lam.py` | `D:\Claude\SVI_FFW\output\step5_nav_webapp\step4_4f_flow_lam.py` |  |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/routing_flow/step4_4d_city_viz.py` | `D:\Claude\SVI_FFW\output\step5_nav_webapp\step4_4d_city_viz.py` |  |
...
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/Constants.py` | `D:\Claude\UNA\Patronage_Flow\Constants.py` | paths and parameters of the demand inputs (madina parameters removed 2026-09-21) |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/loaders.py` | `D:\Claude\UNA\Patronage_Flow\Network.py`, `D:\Claude\UNA\Patronage_Flow\Flow_Computation.py` | the three readers of the demand inputs, moved verbatim 2026-09-21 |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/export_pedestrian_subset.py` | `D:\Claude\UNA\Patronage_Flow\Main.py` (export block) | new 2026-09-21 |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/__init__.py` | `D:\Claude\UNA\Patronage_Flow\__init__.py` | demand_inputs package (formerly Patronage_Flow) |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/build_occupancy_table.py` | `D:\Claude\UNA\Patronage_Flow\build_occupancy_table.py` | demand_inputs package (formerly Patronage_Flow) |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/export_station_hourly.py` | `D:\Claude\UNA\Patronage_Flow\export_station_hourly.py` | demand_inputs package (formerly Patronage_Flow) |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/lookup/mrt_code_to_name.csv` | `D:\Claude\UNA\Patronage_Flow\lookup\mrt_code_to_name.csv` | lookup tables (MRT codes, occupancy density) |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/lookup/occupancy_density.csv` | `D:\Claude\UNA\Patronage_Flow\lookup\occupancy_density.csv` | lookup tables (MRT codes, occupancy density) |
| `4_Pedestrian Flow Mapping/b_Pedestrian OD Flow Assignment (Gravity and Huff model)/demand_inputs/lookup/occupancy_density.parquet` | `D:\Claude\UNA\Patronage_Flow\lookup\occupancy_density.parquet` | lookup tables (MRT codes, occupancy density) |
