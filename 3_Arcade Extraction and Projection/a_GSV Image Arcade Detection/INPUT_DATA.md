...
| Building footprints, Singapore | `Shp/SG/SG_Building/SG_Building_SVY21_TH.shp` | 103,113 polygons, EPSG:3414, field `height` (m) | OSM buildings with heights attached (authors' base data) | `assign_tiers.py` (Tier 1), validation set |
