...
| 1.0.5 (2026-09-19) | `v1.0.5` | assigned by Zenodo when the GitHub release is published (see the Zenodo record) | Module 4a: station exits and demand buildings snap to the main connected component of the network; production edge shade regenerated with the current building-footprint mask; web tool: hourly network shade and routing (Daily time slider), Shade sigma_e button; meteorological forcing files documented as part of the figshare record |
