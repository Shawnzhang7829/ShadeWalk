...
(`building_hourly_weight_gfa.gpkg`; gross floor area = `gfa_corr` of the released building dataset) that part a uses as origin and destination weights, and the OSM pedestrian subset
