...
BTN_OLD='<button class="btn" id="cShade" title="路段遮荫率 σₑ(随日间时刻)">遮荫率 σₑ</button>'
BTN_NEW='<button class="btn" id="cShade" title="路段遮荫率 σₑ(随日间时刻)">遮荫率 σₑ</button><button class="btn" id="cRho">路段成本 ωᵢ</button>'
