...
the derived products (`pedestrian_network_filtered.gpkg`, `station_hourly_ridership.gpkg` and its per-exit-point form `station_hourly_ridership_v4.gpkg`, `building_hourly_weight.gpkg` and its `gfa_corr` form `building_hourly_weight_gfa.gpkg`,
